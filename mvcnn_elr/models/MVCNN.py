...
class SVCNN(Model):
    ...
    def __init__(self, name, nclasses=40, pretraining=True, cnn_name='vgg11', classnames=None):
...
class MVCNN(Model):
    ...
    def __init__(self, name, model, nclasses=40, cnn_name='vgg11', num_views=12, classnames=None):
