...
from mvcnn_elr.models.Model import Model
...
class GVCNN(Model):
    def __init__(self, name, nclasses=40, pretraining=True, cnn_name='googlenet', group_num=8):
        super(GVCNN, self).__init__(name)

        self.num_classes = nclasses
        self.group_num = group_num

        if cnn_name == 'googlenet':
            base_model = torchvision.models.googlenet(pretrained=pretraining)
